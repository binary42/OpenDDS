...
void gen_find_size(const ExampleApp::Data& stru, size_t& size, size_t& padding)
{
  ...
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.test) + 1;
  if ((size + padding) % 8) {
...
struct MetaStructImpl<ExampleApp::Data> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in struct ExampleApp::Data)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + std::string(field) + " not valid for struct ExampleApp::Data");
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "test") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->test, static_cast<const T*>(rhs)->test);
    }
    if (std::strcmp(field, "value") == 0) {
...
void gen_find_size(const ExampleApp::Event& stru, size_t& size, size_t& padding)
{
  ...
  ACE_UNUSED_ARG(padding);
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.kicker) + 1;
  if ((size + padding) % 8) {
    padding += 8 - ((size + padding) % 8);
  }
  size += gen_max_marshaled_size(stru.timestamp);
...
void gen_find_size(KeyOnly<const ExampleApp::Event> stru, size_t& size, size_t& padding)
{
  ...
  ACE_UNUSED_ARG(padding);
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.t.kicker) + 1;
}
...
EventTypeSupportImpl::EventTypeSupportImpl ()
{
}
...
::DDS::DataWriter_ptr
EventTypeSupportImpl::create_datawriter ()
{
  EventDataWriterImpl* writer_impl;
...
::DDS::DataReader_ptr
EventTypeSupportImpl::create_datareader ()
{
  EventDataReaderImpl* reader_impl = 0;
...
::DDS::DataReader_ptr
EventTypeSupportImpl::create_multitopic_datareader()
{
  return new OpenDDS::DCPS::MultiTopicDataReader_T<Event,
    EventDataReaderImpl>;
}
#endif
...
EventTypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<Event>();
}

#endif

bool
EventTypeSupportImpl::has_dcps_key()
{
  return OpenDDS::DCPS::gen_has_key(Event());
}


EventDataWriterImpl::EventDataWriterImpl ()
  : marshaled_size_ (0)
...
EventDataWriterImpl::register_instance (
...
::DDS::InstanceHandle_t
EventDataWriterImpl::register_instance_w_timestamp (
    const ::ExampleApp::Event & instance,
...
::DDS::ReturnCode_t
EventDataWriterImpl::unregister_instance (
    const ::ExampleApp::Event & instance,
...
::DDS::ReturnCode_t
EventDataWriterImpl::unregister_instance_w_timestamp (
    const ::ExampleApp::Event & instance,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & timestamp)
{
...
::DDS::ReturnCode_t
EventDataWriterImpl::write_w_timestamp (
    const ::ExampleApp::Event & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp)
{
  ...
  if (handle == ::DDS::HANDLE_NIL) {
    ...
    if (ret != ::DDS::RETCODE_OK) {
      ACE_ERROR_RETURN((LM_ERROR,
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("EventDataWriterImpl::write, ")
...
::DDS::ReturnCode_t
EventDataWriterImpl::dispose_w_timestamp (
    const ::ExampleApp::Event & instance_data,
    ::DDS::InstanceHandle_t instance_handle,
    const ::DDS::Time_t & source_timestamp)
{
  if(instance_handle == ::DDS::HANDLE_NIL)
  {
    ...
    if (instance_handle == ::DDS::HANDLE_NIL)
    {
      ACE_ERROR_RETURN ((LM_ERROR,
                         ACE_TEXT("(%P|%t) ")
                         ACE_TEXT("EventDataWriterImpl::dispose, ")
...
::DDS::ReturnCode_t
EventDataWriterImpl::get_key_value (
...
::DDS::InstanceHandle_t
EventDataWriterImpl::lookup_instance (
    const ::ExampleApp::Event & instance_data)
{
  ACE_GUARD_RETURN (ACE_Recursive_Thread_Mutex,
                    guard,
    ...
    )
{
  ...
  OpenDDS::DCPS::KeyOnly<const ::ExampleApp::Event > ko(data);
...
::DDS::ReturnCode_t
EventDataWriterImpl::enable_specific ()
{
  ::ExampleApp::Event data;
  if (OpenDDS::DCPS::gen_is_bounded_size (data))
  {
    ...
    if (::OpenDDS::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,
                 ACE_TEXT("(%P|%t) EventDataWriterImpl::")
  ...
  else
  {
    if (::OpenDDS::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,
                 ACE_TEXT("(%P|%t) EventDataWriterImpl::enable_specific")
...
// Note: The EventDataWriter gives ownership of the marshalled data
//       to the WriteDataContainer.
ACE_Message_Block*
EventDataWriterImpl::dds_marshal(
  const ::ExampleApp::Event& instance_data,
  OpenDDS::DCPS::MarshalingType marshaling_type)
{
  ...
  if (marshaling_type == OpenDDS::DCPS::KEY_ONLY_MARSHALING) {
    ...
    OpenDDS::DCPS::KeyOnly<const ::ExampleApp::Event > ko_instance_data(instance_data);
...
::DDS::ReturnCode_t
EventDataWriterImpl::get_or_create_instance_handle(
  ::DDS::InstanceHandle_t& handle,
  const ::ExampleApp::Event& instance_data,
  const ::DDS::Time_t & source_timestamp)
{
    ...
    if (needs_creation)
    {
      ...
      if (pair.second == false)
      {
        ...
        ACE_ERROR_RETURN ((LM_ERROR,
                           ...
                           ACE_TEXT("insert ExampleApp::Event failed. \n")),
                          ::DDS::RETCODE_ERROR);
      }
...
void
EventDataWriterImpl::unregistered(
  ::DDS::InstanceHandle_t /* instance_handle */)
{
...
EventDataReaderImpl::EventDataReaderImpl ()
  : data_allocator_ (0)
{
}

::DDS::ReturnCode_t
EventDataReaderImpl::enable_specific ()
{
  data_allocator_ = new DataAllocator(get_n_chunks ());
  if (::OpenDDS::DCPS::DCPS_debug_level >= 2)
    ACE_DEBUG((LM_DEBUG,
               ACE_TEXT("(%P|%t) EventDataReaderImpl::")
               ACE_TEXT("enable_specific-data")
               ACE_TEXT(" Cached_Allocator_With_Overflow ")
               ACE_TEXT("%x with %d chunks\n"),
               data_allocator_,
...
#endif
{
  ::ExampleApp::EventSeq::PrivateMemberAccess received_data_p(received_data);
  ...
  ::OpenDDS::DCPS::RakeResults< ::ExampleApp::EventSeq >
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_w_condition (
    ::ExampleApp::EventSeq & received_data,
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_w_condition (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & sample_info,
    ::CORBA::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition)
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_next_sample (
        ...
        (ptr->instance_state_.instance_state() & ::DDS::ANY_INSTANCE_STATE))
    {
           ...
           item = item->next_data_sample_)
      {
        ...
        if (item->sample_state_ & ::DDS::NOT_READ_SAMPLE_STATE)
        {
          ...
          {
            received_data =
              *static_cast< ::ExampleApp::Event *> (item->registered_data_);
          }
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_next_sample (
    ::ExampleApp::Event & received_data,
    ::DDS::SampleInfo & sample_info)
{
  bool found_data = false;
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_instance (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_instance_i (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_instance (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_instance_i (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_next_instance (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_next_instance_i (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_next_instance (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_next_instance_i (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_next_instance_w_condition (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
EventDataReaderImpl::take_next_instance_w_condition (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
void
EventDataReaderImpl::release_loan (
    ::ExampleApp::EventSeq & received_data
  )
{
...
void
EventDataReaderImpl::dec_ref_data_element(
...
::DDS::ReturnCode_t
EventDataReaderImpl::return_loan (
    ::ExampleApp::EventSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq)
{
...
::DDS::ReturnCode_t
EventDataReaderImpl::get_key_value (
    ::ExampleApp::Event & key_holder,
    ::DDS::InstanceHandle_t handle)
{
  ACE_GUARD_RETURN (ACE_Recursive_Thread_Mutex,
...
::DDS::InstanceHandle_t
EventDataReaderImpl::lookup_instance (
    const ::ExampleApp::Event & instance_data)
{
  InstanceMap::const_iterator const it = instance_map_.find(instance_data);
...
#ifndef OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE
bool
EventDataReaderImpl::contains_sample_filtered(::DDS::SampleStateMask sample_states,
    ...
    if ((inst.instance_state_.view_state() & view_states) &&
      ...
      for (ReceivedDataElement* item = inst.rcvd_samples_.head_; item != 0;
        ...
        if (item->sample_state_ & sample_states
          ...
          if (evaluator.eval(*static_cast< ::ExampleApp::Event* >(item->registered_data_), params)) {
            return true;
          }
        }
      }
...
::DDS::ReturnCode_t
EventDataReaderImpl::read_generic(
...
::DDS::InstanceHandle_t
EventDataReaderImpl::lookup_instance_generic(const void* data)
{
  return lookup_instance(*static_cast<const ExampleApp::Event*>(data));
}

::DDS::ReturnCode_t
EventDataReaderImpl::read_instance_generic(void*& data,
  ::DDS::SampleInfo& info, ::DDS::InstanceHandle_t instance,
  ::DDS::SampleStateMask sample_states, ::DDS::ViewStateMask view_states,
  ::DDS::InstanceStateMask instance_states)
{
  ExampleApp::EventSeq dataseq;
  ...
  data = new ExampleApp::Event(dataseq[last]);
  info = infoseq[last];
  return rc;
}

::DDS::ReturnCode_t
EventDataReaderImpl::read_next_instance_generic(void*& data,
...
::DDS::InstanceHandle_t
EventDataReaderImpl::store_synthetic_data(const ExampleApp::Event& sample,
  ::DDS::ViewStateKind view)
{
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    ACE_NEW_MALLOC_NORETURN(data,
      static_cast< ExampleApp::Event*>(data_allocator_->malloc(sizeof(ExampleApp::Event))),
      ExampleApp::Event(sample));
...
void
EventDataReaderImpl::set_instance_state(::DDS::InstanceHandle_t instance,
...
void
EventDataReaderImpl::dds_demarshal(
  ...
  OpenDDS::DCPS::MarshalingType marshaling_type)
{
  ...
  ACE_NEW_MALLOC_NORETURN(data,
                          static_cast< ::ExampleApp::Event *>(
                            data_allocator_->malloc(sizeof(::ExampleApp::Event))),
                           ::ExampleApp::Event);
  ...
  if (marshaling_type == OpenDDS::DCPS::KEY_ONLY_MARSHALING) {
    ser >> ::OpenDDS::DCPS::KeyOnly< ::ExampleApp::Event>(*data);
  } else {
    ser >> *data;
  }
...
void
EventDataReaderImpl::lookup_instance(const OpenDDS::DCPS::ReceivedDataSample& sample,
                                        OpenDDS::DCPS::SubscriptionInstance*& instance)
{
...
void
EventDataReaderImpl::store_instance_data(
      ...
      if (new_handle) {
        ...
        if (bpair.second == false)
        {
          ACE_ERROR ((LM_ERROR,
                      ...
                      ACE_TEXT("EventDataReaderImpl::")
                      ACE_TEXT("store_instance_data, ")
                      ACE_TEXT("insert to participant scope ::ExampleApp::Event failed. \n")));
          return;
        }
      }
...
void
EventDataReaderImpl::notify_status_condition_no_sample_lock()
{
...
void
EventDataReaderImpl::dispose_unregister(const OpenDDS::DCPS::ReceivedDataSample& sample,
                                           OpenDDS::DCPS::SubscriptionInstance*& instance)
{
  //!!! caller should already have the sample_lock_
...
::DDS::ReturnCode_t
EventDataReaderImpl::auto_return_loan(void* seq)
{
  ::ExampleApp::EventSeq& received_data =
    *static_cast< ::ExampleApp::EventSeq*> (seq);
...
::DDS::ReturnCode_t
EventDataReaderImpl::check_inputs (
  ...
  )
{
  ...
  {
    ACE_DEBUG((LM_DEBUG,
               ACE_TEXT("(%P|%t) EventDataReaderImpl::%C ")
...
void
EventDataReaderImpl::purge_data(
    OpenDDS::DCPS::SubscriptionInstance* instance)
{
...
void
EventDataReaderImpl::release_instance_i (::DDS::InstanceHandle_t handle)
{
  InstanceMap::iterator const the_end = instance_map_.end ();
...
void
EventDataReaderImpl::delete_instance_map (void* map)
{
...
struct MetaStructImpl<ExampleApp::Event> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    ACE_UNUSED_ARG(typed);
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in struct ExampleApp::Event)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + std::string(field) + " not valid for struct ExampleApp::Event");
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    ACE_UNUSED_ARG(rhs);
    if (std::strcmp(field, "kicker") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->kicker, static_cast<const T*>(rhs)->kicker);
    }
    if (std::strcmp(field, "timestamp") == 0) {
      return static_cast<const T*>(lhs)->timestamp == static_cast<const T*>(rhs)->timestamp;
    }
