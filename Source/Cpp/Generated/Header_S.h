...
#ifndef _TAO_IDL____SOURCE_CPP_GENERATED__HEADER_S_MXIWUZ_H_
#define _TAO_IDL____SOURCE_CPP_GENERATED__HEADER_S_MXIWUZ_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::std_msgs::msg::dds_::Header_>
    : public
