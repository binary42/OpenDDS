...
#ifndef _TAO_IDL____SOURCE_CPP_GENERATED__TIME_S_VLDXZN_H_
#define _TAO_IDL____SOURCE_CPP_GENERATED__TIME_S_VLDXZN_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::builtin_interfaces::msg::dds_::Time_>
    : public
...
namespace POA_builtin_interfaces
{
